...
export default function ResumeLayout({ children }: Props): ReactNode {
  return (
    <main className="flex justify-between flex-1 h-screen">
      <span className="bg-cover bg-gradient-to-t from-background from-90% to-100% dark:to-primary-foreground/30 to-secondary/50 absolute top-0 left-0 right-0 bottom-0 z-0" />
