...
class EncryptUseCase {
  ...
  public encrypt(data: string): string {
    ...
    /**
     * 6) El cliente reune tanto los datos cifrados como la clave AES 
     * cifrada al servidor.
     */
    ...
    /**
     * 7) (Opcional) Compresión de los datos cifrados.
     * 8) Finalmente, se retorna la información cifrada y 
     * comprimida al cliente.
     */
...
class DecryptUseCase {
  ...
  public decrypt(encryptedData: string): string {
    ...
    /**
     * 3) Se descifra la clave AES utilizando la clave 
     * privada RSA del servidor.
     */
     ...
     * Si el HMAC no coincide, se pretende que los datos han sido 
     * alterados por lo tanto se lanza una excepción de error.
     */
    const hmacMessage = StringUtils.concat(
      encryptedOutput.d, 
      encryptedOutput.k, 
    ...
    /**
     * 5) Finalmente, se descifran los datos utilizando 
     * la clave AES descifrada y el IV.
     */
