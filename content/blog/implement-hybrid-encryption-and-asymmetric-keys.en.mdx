...
class EncryptUseCase {
  ...
  public encrypt(data: string): string {
    ...
    /**
     * 2) Additionally, a random initialization vector (IV) is generated.
     * This ensures that each encrypted message is unique.
     */
    ...
    /**
     * 6) The client gathers both the encrypted data and the encrypted AES key to send to the server.
     */
    ...
    /**
     * 7) (Optional) Compression of encrypted data to optimize transmission.
     * 8) Finally, the encrypted and compressed information is returned to the client.
     */
